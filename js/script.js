...
//     if (!slider.classList.contains('swiper-biuld')) {
...
// function slidersBuildCallback(params) { }

// let mainSlider = new Swiper('.slider-claccic__swiper-wrapper', {
// effect: 'fade',
// autoplay: {
//   delay: 3000,
...
// Arrows
// navigation: {
//   nextEl: '.about__more .more__itemNext',
//   prevEl: '.about__more .more__itemPrev',
// },
// breakpoint: {
//   320: {
//     slidesPerView: 1,
...
let slider = new Swiper('.slider-claccic__swiper-container', {
  // Optional parameters
  // direction: 'vertical',
  speed: 400,
  spaceBetween: 0,
...
let galleryThumbs = new Swiper('.modal-body__slider-contain', {
  spaceBetween: 10,
  slidesPerView: 4,
  loop: true,
  freeMode: true,
...
let galleryTop = new Swiper('.modal-body__slider-container', {
  spaceBetween: 10,
  loop: true,
  thumbs: {
...
const classic = document.querySelector('.slider-class');
const neo = document.querySelector('.slider-neoclass');
const modern = document.querySelector('.slider-modern');
const linkScroll = document.querySelectorAll('.header-list__link--scroll')


if (linkScroll.length > 0) {

  for (let i = 0; i < linkScroll.length; i++) {
    const link = linkScroll[i];
    link.addEventListener('click', () => {
      if (i == 0) {
        const a = offset(classic).top;
        window.scrollTo({
          top: a,
          behavior: "smooth"
        });
